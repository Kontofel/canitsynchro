...
Arguments:
  -h, --help    show help
  -min MIN      Minimum Jump in percent divided by 100 (default: 0.08)
  -max MAX      Maximum Jump in percent divided by 100 (default: 0.16)
  -adj ADJ      Adjacent shift tolerance, i.e compare percentual jump to the ones that come before/after (default:
                0.1)
  -small SMALL  Number of small cogs to restrict on the small ring (default: 3)
  -big BIG      Number of large cogs to restrict on the big ring (default: 2)
